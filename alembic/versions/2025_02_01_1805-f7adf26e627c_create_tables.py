...
Revision ID: f7adf26e627c
Revises:
Create Date: 2025-02-01 18:05:29.223260
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_haircutting_days_id"), "haircutting_days", ["id"], unique=True)
    op.create_table(
        "la_positions",
        sa.Column("moon_day", sa.Integer(), nullable=False),
        sa.Column("en_name", sa.String(length=100), nullable=False),
    ...
    op.create_index(op.f("ix_skylight_arches_id"), "skylight_arches", ["id"], unique=True)
    op.create_table(
        "users",
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column("first_element_id", sa.Integer(), nullable=False),
        sa.Column("second_element_id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(["day_info_id"], ["day_info.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_descriptions_id"), "descriptions", ["id"], unique=True)
